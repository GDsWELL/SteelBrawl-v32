namespace Supercell.Laser.Logic.Home.Quest
{
    ...
    public class Quest
    {
        ...
        public bool BrawlPassExclusive { get; set; }
        ...
        public Quest Clone()
        {
            return new Quest()
            {
                ...
                BrawlPassExclusive = BrawlPassExclusive,
                QuestSeen = QuestSeen,
        ...
        public void Encode(ChecksumEncoder encoder)
        {
            ...
            encoder.WriteVInt(3);  // Brawl pass season
            ...
            encoder.WriteVInt(IsDailyQuest ? 1 : -1);  // Quest Timer

            encoder.WriteBoolean(BrawlPassExclusive); // unknown
